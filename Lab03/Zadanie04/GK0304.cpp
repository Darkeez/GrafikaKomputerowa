...
float windowPos[6][3] = { { 0.1,-0.3, 0.51 },{ -0.25, -0.3, 0.51 },{ 0.1,-0.8, 0.51 },{ -0.25, -0.8, 0.51 },{ 0.1,-0.3, -0.51 },{ -0.25, -0.3, -0.51 } };
...
void GenerateTextures()
{
	...
	// wczytanie tekstury Wall.tga
	error = load_targa("Wall.tga", width, height, format, type, pixels);

	// b³¹d odczytu pliku
	if (error == GL_FALSE)
	{
		printf("Niepoprawny odczyt pliku Wall.tga");
		//exit(0);
	}
